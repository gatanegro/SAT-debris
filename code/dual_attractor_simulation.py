...
def generate_all_visualizations():
    ...
    fig_path = '/home/ubuntu/dual_attractor_map.png'
    ...
    fig_path = '/home/ubuntu/dual_debris_drift.png'
    fig.savefig(fig_path, dpi=300, bbox_inches='tight')
    plt.close(fig)
    ...
    fig_path = '/home/ubuntu/dual_collector_field.png'
    fig.savefig(fig_path, dpi=300, bbox_inches='tight')
    plt.close(fig)
    ...
    fig_path = '/home/ubuntu/dual_attractor_components.png'
    fig.savefig(fig_path, dpi=300, bbox_inches='tight')
    plt.close(fig)
    ...
    fig_path = '/home/ubuntu/dual_radii_verification.png'
    fig.savefig(fig_path, dpi=300, bbox_inches='tight')
    plt.close(fig)
